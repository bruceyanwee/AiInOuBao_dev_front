  ...
  <view class="content">
    ...
    <view class="list">
      <view class="list-call">
        <image class="img" src="../../static/pics/avater_img.png"></image>
      ...
      <view class="list-call">
        ...
        <image class="img" :src="showPassword?'../../static/pics/avater_img.png':'../../static/pics/avater_img.png'" @tap="display"></image>
      </view>
      <view class="list-call">
        <image class="img" src="../../static/pics/avater_img.png"></image>
